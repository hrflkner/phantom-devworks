                    ...
                    <section className="upgrade-secondary">
                        ...
                        <dl>
                            ...
                            <dd className="fadeInLeft">
                                ...
                                should have no trouble interacting with your
                                site to get to know your business.
                            </dd>
                            <img
                                src={ResponsiveIcon}
                            ...
                            <dd className="fadeInLeft">
                                Offer user friendly experiences that are
                            ...
                            <dd className="fadeInLeft">
                                ...
                                contributes to higher visibility online. This
                                helps to allow more people to find your service
                                or product at the top of the search results!
                            </dd>
                            <img
                                src={SearchableIcon}
                                alt="Searchable Icon"
